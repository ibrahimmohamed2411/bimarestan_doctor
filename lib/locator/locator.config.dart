...
import 'package:bimarestan_doctors/core/api/api_consumer.dart' as _i14;
import 'package:bimarestan_doctors/core/api/app_interceptors.dart' as _i16;
import 'package:bimarestan_doctors/core/api/dio_consumer.dart' as _i15;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i9.RxSharedPreferences>(() => registerModule.rxPref);
  await gh.factoryAsync<_i9.SharedPreferences>(
    () => registerModule.prefs,
    preResolve: true,
  );
  gh.factory<_i10.SignUpProvider>(() => _i10.SignUpProvider());
  ...
  gh.lazySingleton<_i13.UserLocalDataSource>(() => _i13.UserLocalDataSource(
      rxSharedPreferences: gh<_i9.RxSharedPreferences>()));
  gh.lazySingleton<_i14.ApiConsumer>(
      () => _i15.DioConsumer(client: gh<_i5.Dio>()));
  gh.lazySingleton<_i16.AppInterceptors>(() => _i16.AppInterceptors(
      userLocalDataSource: gh<_i13.UserLocalDataSource>()));
  gh.lazySingleton<_i17.UserRemoteDataSource>(
      () => _i17.UserRemoteDataSource(apiConsumer: gh<_i14.ApiConsumer>()));
  gh.lazySingleton<_i18.UserRepository>(() => _i18.UserRepository(
        userRemoteDataSource: gh<_i17.UserRemoteDataSource>(),
        userLocalDataSource: gh<_i13.UserLocalDataSource>(),
      ));
  return getIt;
}
