class EndPoints {
  ...
  static const String getClinicsByDoctorId =
      '${baseUrl}clinic/getAllClinicsByDoctor';
  ...
  static const String getAllAppointmentsByClinicIdAndDate =
      '${baseUrl}appointment/getAllAppointmentsByClinicIdByDate';
